...
import type { UserQuery, UserVO } from '@namewta/domain-system-admin';
...
const props = defineProps({
  runtime: {
    type: Object as PropType<SystemAdminWebRuntime>,
    required: true
  },
  roleId: {
    type: [Number, String],
...
const { selectUsers: authUserSelectAll, unallocatedUsers: unallocatedUserList } = runtime.service.roles;
const modal = { msgError: runtime.error, msgSuccess: runtime.success };
...
.select-user-shell { display: flex; flex-direction: column; gap: 12px; }
.select-user-dialog :deep(.el-dialog__body) { padding-top: 12px; }
