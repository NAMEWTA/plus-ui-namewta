...
type ThirdPageKind = 'providers' | 'endpoints' | 'credentials' | 'invocations' | 'statistics';
...
export function createThirdWebDomain(runtime: ThirdWebRuntime): WebDomainManifest<Component> {
  const registrations = [
    ...
    ['third-credential', 'third/credential/index', 'ThirdCredential', view('ThirdCredential', 'credentials', runtime)],
  ...
  return Object.freeze({ id: 'web-domain-third', domainId: 'third', messages: Object.freeze([{ namespace: 'thirdAdmin', messages: Object.freeze({ title: '三方接口管理' }) }]), permissions: Object.freeze([
    Object.freeze({ id: 'third-provider', permissions: Object.freeze(['third:provider:list', 'third:provider:query', 'third:provider:add', 'third:provider:edit', 'third:provider:remove']) }),
    ...
    Object.freeze({ id: 'third-credential', permissions: Object.freeze(['third:credential:list', 'third:credential:add', 'third:credential:remove']) }),
