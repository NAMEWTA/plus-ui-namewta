...
import type { NotifyDetailVO } from '@namewta/domain-system/monitor';
import { ref } from 'vue';
...
const { get: getNotifyDetail } = runtime.service.notifications;
...
const downloadAttachment = async (ossId: string | number) => {
  ...
  await downloadNotificationAttachment(runtime, detail.value.notification.notifyLogId, ossId);
};
