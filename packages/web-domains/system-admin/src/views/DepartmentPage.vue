...
import type { DeptForm, DeptQuery, DeptVO, UserVO } from '@namewta/domain-system-admin';
import type { FormInstance as ElFormInstance, TableInstance as ElTableInstance } from 'element-plus';
import { onMounted, reactive, ref, toRefs } from 'vue';
import { useDialogState, useLoading, useSearchReset, useSearchToggle, useTreeTableExpand } from '../composables';
...
const { list: listDept, get: getDept, delete: delDept, add: addDept, update: updateDept, excludeChildren: listDeptExcludeChild } = runtime.service.departments;
const listUserByDeptId = runtime.service.users.listByDepartment;
...
const { sys_normal_disable } = runtime.dicts('sys_normal_disable');
