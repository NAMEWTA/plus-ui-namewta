...
import type { ClientForm, ClientQuery, ClientVO, RoleQuery, RoleVO, UserTypeVO } from '@namewta/domain-system-admin';
...
const { list: listClient, get: getClient, delete: delClient, add: addClient, update: updateClient, changeStatus } = runtime.service.clients;
...
const { sys_normal_disable, sys_grant_type, sys_device_type } = runtime.dicts(
  'sys_normal_disable', 'sys_grant_type', 'sys_device_type'
);
