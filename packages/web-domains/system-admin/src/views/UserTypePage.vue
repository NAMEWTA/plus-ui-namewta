...
import type { UserTypeForm, UserTypeQuery, UserTypeVO } from '@namewta/domain-system-admin';
...
const { add: addUserType, delete: delUserType, get: getUserType, list: listUserType, update: updateUserType } = runtime.service.userTypes;
