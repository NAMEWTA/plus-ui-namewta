...
import type { DeptTreeVO, DeptVO, PostForm, PostQuery, PostVO } from '@namewta/domain-system-admin';
import type { FormInstance as ElFormInstance } from 'element-plus';
import { onMounted, reactive, ref, toRefs } from 'vue';
import { useFormDialog, useLoading, useSearchReset, useSearchToggle, useTableSelection, useTreeCollapsed } from '../composables';
...
const { add: addPost, delete: delPost, get: getPost, list: listPost, update: updatePost, departmentTree: deptTreeSelect } = runtime.service.posts;
