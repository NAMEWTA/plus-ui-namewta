...
const getList = async () => {
  const loadingHandle = runtime.loading('正在加载缓存监控数据，请稍候！');
  try {
    ...
    runtime.closeLoading(loadingHandle);
  }
};
