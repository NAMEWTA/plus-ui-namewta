import type { PublicDictType } from '@namewta/domain-system-admin/public/dict';
import type { PublicMenuOption } from '@namewta/domain-system-admin/public/menu';

export type DevtoolsDictType = PublicDictType;
export type DevtoolsMenuOption = PublicMenuOption;
