<template>
  <div class="gen-generator-edit app-container">
...
import type { DbColumnVO, DbTableForm, DbTableVO, GenDictType, GenMenuOption } from '@namewta/domain-gen';
...
const dictTypes = ref<GenDictType[]>([]);
const menus = ref<GenMenuOption[]>([]);
