  ...
  <div class="p-2 app-container role-auth-user-page">
    ...
    <el-card shadow="hover" class="table-panel">
      ...
      <pagination
        ...
        @pagination="getList"
      />
      <select-user ref="selectRef" :runtime="runtime" :role-id="queryParams.roleId" @ok="handleQuery" />
    </el-card>
  </div>
</template>
...
import { useLoading, useSearchReset, useSearchToggle, useTableSelection } from '../composables';
import SelectUser from './RoleSelectUser.vue';

const { runtime } = defineProps<{ runtime: SystemAdminWebRuntime }>();
const route = useRoute();
const {
  allocatedUsers: allocatedUserList,
  cancelUser: authUserCancel,
  cancelUsers: authUserCancelAll
...
// 返回按钮
const handleClose = () => {
  runtime.closeAndOpenPage({ path: '/system/role' });
};
/** 搜索按钮操作 */
const handleQuery = () => {
