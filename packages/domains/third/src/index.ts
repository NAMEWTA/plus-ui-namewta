...
export function createThirdService(http: HttpClient): ThirdService {
  ...
  return Object.freeze({
    ...
    changeProviderStatus: (value, status) => call<void>({ url: `/third/provider/${id(value)}/status`, method: 'put', data: { status } }),
    deleteProvider: value => call<void>({ url: `/third/provider/${id(value)}`, method: 'delete' }),
    ...
    changeEndpointStatus: (value, status) => call<void>({ url: `/third/endpoint/${id(value)}/status`, method: 'put', data: { status } }),
    deleteEndpoint: value => call<void>({ url: `/third/endpoint/${id(value)}`, method: 'delete' }),
    ...
    deleteCredential: value => call<void>({ url: `/third/credential/${id(value)}`, method: 'delete' }),
