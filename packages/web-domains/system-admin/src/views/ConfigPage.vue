...
import type { ConfigForm, ConfigQuery, ConfigVO } from '@namewta/domain-system-admin';
import type { FormInstance as ElFormInstance } from 'element-plus';
import { onMounted, reactive, ref, toRefs } from 'vue';
import type { SystemAdminWebRuntime } from '../runtime';
import { useFormDialog, useLoading, useSearchReset, useSearchToggle } from '../composables';
...
const {
  ...
  add: addConfig,
  update: updateConfig,
  updateByKey: updateConfigByKey,
  refreshCache
} = runtime.service.resources.configs;
