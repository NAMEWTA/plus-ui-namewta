import type { DictTypeCatalogPort } from '@namewta/domain-system/dict-type';
import type { MenuQueryPort } from '@namewta/domain-system/menu';
...
export const genDomainModule: DomainModule = Object.freeze({
  id: 'gen',
  backendModules: Object.freeze(['ruoyi-gen']),
...
export function createGenService(
  http: HttpClient,
