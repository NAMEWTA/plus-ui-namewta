...
import type {
  ClientVO, DeptTreeOption, MenuTreeOption, RoleForm, RoleMenuButtonOption, RoleMenuTree, RoleQuery, RoleVO
...
import {
  useDateRangeQuery, useDialogState, useLoading, useSearchReset, useSearchToggle, useTableSelection
} from '../composables';
import type { SystemAdminWebRuntime } from '../runtime';
import { MenuTypeEnum, parseTime } from '../utils';

const { runtime } = defineProps<{ runtime: SystemAdminWebRuntime }>();
const router = useRouter();
const listClientOptions = runtime.service.clients.options;
const roleMenuTreeselect = runtime.service.menus.roleTree;
const {
  add: addRole, changeStatus: changeRoleStatus, delete: delRole, get: getRole, list: listRole,
  updatePermission: updateRolePermission, update: updateRole, departmentTree: deptTreeSelect
